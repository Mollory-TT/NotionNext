...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Mollory Info', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '🍚用技术熨平内卷🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://molloryinfo.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI-Hot News', // 网站关键词 英文逗号隔开
